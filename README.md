...
Il piano gratuito di Gemini non conta i token ma le richieste, separatamente per ogni modello. I limiti non sono pubblicati: quelli visti nel 2026 sono circa 15 al minuto e 500 al giorno per i modelli Flash-Lite, e 5 al minuto e 20 al giorno per i modelli Flash. Il conteggio riparte a mezzanotte, ora della California: le 9:00 in Italia quasi tutto l'anno (le 8:00 per qualche settimana a marzo e a fine ottobre, quando l'ora legale americana e quella europea non coincidono).

Per consumare meno:

- **Catena di modelli.** Con "Veloce" l'app usa prima i Flash-Lite (`gemini-3.5-flash-lite`, poi `gemini-3.1-flash-lite`), poi i Flash. Con "Più accurata" parte dai Flash. Quando un modello risponde 429 l'app legge nell'errore quale limite è finito. Se è quello giornaliero, salta quel modello fino al giorno dopo (ogni tanto, o quando premi Riprova, ne riprova uno: serve se nel frattempo hai attivato la fatturazione). Se è quello al minuto, lo salta per il tempo indicato da Google (da 10 secondi a circa un minuto) e, se tutti sono fermi, aspetta da sola e riprova. Un modello che non esiste più (404) viene saltato. Se Google è sovraccarico (errori 5xx), l'app prova al massimo un secondo modello e poi si ferma.
...
- **Frasi pronte.** Circa 190 frasi comuni per una riunione di famiglia (saluti, a tavola, auguri, capirsi…, più una sezione "Ti diranno" con le formule che dicono i parenti e la risposta di rito), già tradotte in darija, con le forme giuste per uomo, donna o più persone. Non usano internet né la chiave. Se scrivi una di queste frasi, l'app la riconosce e non chiama Gemini. Sono state scritte e ricontrollate con l'IA, non da un madrelingua: conviene farle rileggere a un parente.
- **Memoria.** Una frase scritta identica a una già tradotta, con le stesse impostazioni, viene ripresa dalla memoria (ultime 300). Gemini segnala le traduzioni che dipendono dalla conversazione (per esempio "Quanti anni ha?"), e quelle non vengono salvate. Il pulsante "Traduci con Gemini" ritraduce comunque.
- Nelle impostazioni, "Consumo di oggi" mostra quante traduzioni ha fatto ogni modello e quali sono finiti.
